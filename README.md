![Build Status](https://github.com/vishal-ahirwar/ccli/actions/workflows/cmake-multi-platform.yml/badge.svg?event=push)

# C/C++ CLI Open Source Project

# How to build ccli & install on your system
### Download zip or clone ccli github repo
```
git clone https://github.com/vishal-ahirwar/ccli
cd ccli
bash.sh
sudo make install
```
